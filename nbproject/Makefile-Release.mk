...
${TESTDIR}/src/tests/newsimpletest1.o: src/tests/newsimpletest1.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/src/tests/newsimpletest1.o src/tests/newsimpletest1.cpp
...
${OBJECTDIR}/src/Ammobox_nomain.o: ${OBJECTDIR}/src/Ammobox.o src/Ammobox.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Ammobox_nomain.o src/Ammobox.cpp;\
	else  \
...
${OBJECTDIR}/src/Application_nomain.o: ${OBJECTDIR}/src/Application.o src/Application.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Application_nomain.o src/Application.cpp;\
	else  \
...
${OBJECTDIR}/src/Audio_nomain.o: ${OBJECTDIR}/src/Audio.o src/Audio.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Audio_nomain.o src/Audio.cpp;\
	else  \
...
${OBJECTDIR}/src/DetTile_nomain.o: ${OBJECTDIR}/src/DetTile.o src/DetTile.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/DetTile_nomain.o src/DetTile.cpp;\
	else  \
...
${OBJECTDIR}/src/Editor_nomain.o: ${OBJECTDIR}/src/Editor.o src/Editor.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Editor_nomain.o src/Editor.cpp;\
	else  \
...
${OBJECTDIR}/src/Fixed_Switch_nomain.o: ${OBJECTDIR}/src/Fixed_Switch.o src/Fixed_Switch.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Fixed_Switch_nomain.o src/Fixed_Switch.cpp;\
	else  \
...
${OBJECTDIR}/src/Game_nomain.o: ${OBJECTDIR}/src/Game.o src/Game.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Game_nomain.o src/Game.cpp;\
	else  \
...
${OBJECTDIR}/src/Global_nomain.o: ${OBJECTDIR}/src/Global.o src/Global.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Global_nomain.o src/Global.cpp;\
	else  \
...
${OBJECTDIR}/src/Grid_nomain.o: ${OBJECTDIR}/src/Grid.o src/Grid.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Grid_nomain.o src/Grid.cpp;\
	else  \
...
${OBJECTDIR}/src/Guard_nomain.o: ${OBJECTDIR}/src/Guard.o src/Guard.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Guard_nomain.o src/Guard.cpp;\
	else  \
...
${OBJECTDIR}/src/Level_nomain.o: ${OBJECTDIR}/src/Level.o src/Level.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Level_nomain.o src/Level.cpp;\
	else  \
...
${OBJECTDIR}/src/Menu_nomain.o: ${OBJECTDIR}/src/Menu.o src/Menu.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Menu_nomain.o src/Menu.cpp;\
	else  \
...
${OBJECTDIR}/src/MobileBoxes_nomain.o: ${OBJECTDIR}/src/MobileBoxes.o src/MobileBoxes.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MobileBoxes_nomain.o src/MobileBoxes.cpp;\
	else  \
...
${OBJECTDIR}/src/Monster_nomain.o: ${OBJECTDIR}/src/Monster.o src/Monster.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Monster_nomain.o src/Monster.cpp;\
	else  \
...
${OBJECTDIR}/src/Projectile_nomain.o: ${OBJECTDIR}/src/Projectile.o src/Projectile.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Projectile_nomain.o src/Projectile.cpp;\
	else  \
...
${OBJECTDIR}/src/Settings_nomain.o: ${OBJECTDIR}/src/Settings.o src/Settings.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Settings_nomain.o src/Settings.cpp;\
	else  \
...
${OBJECTDIR}/src/Sight_nomain.o: ${OBJECTDIR}/src/Sight.o src/Sight.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Sight_nomain.o src/Sight.cpp;\
	else  \
...
${OBJECTDIR}/src/Text_nomain.o: ${OBJECTDIR}/src/Text.o src/Text.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Text_nomain.o src/Text.cpp;\
	else  \
...
${OBJECTDIR}/src/Timed_Gate_nomain.o: ${OBJECTDIR}/src/Timed_Gate.o src/Timed_Gate.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Timed_Gate_nomain.o src/Timed_Gate.cpp;\
	else  \
...
${OBJECTDIR}/src/Timer_nomain.o: ${OBJECTDIR}/src/Timer.o src/Timer.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Timer_nomain.o src/Timer.cpp;\
	else  \
...
${OBJECTDIR}/src/UI_Button_nomain.o: ${OBJECTDIR}/src/UI_Button.o src/UI_Button.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/UI_Button_nomain.o src/UI_Button.cpp;\
	else  \
...
${OBJECTDIR}/src/UI_Checkbox_nomain.o: ${OBJECTDIR}/src/UI_Checkbox.o src/UI_Checkbox.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/UI_Checkbox_nomain.o src/UI_Checkbox.cpp;\
	else  \
...
${OBJECTDIR}/src/UI_IPfield_nomain.o: ${OBJECTDIR}/src/UI_IPfield.o src/UI_IPfield.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/UI_IPfield_nomain.o src/UI_IPfield.cpp;\
	else  \
...
${OBJECTDIR}/src/UI_TextLabel_nomain.o: ${OBJECTDIR}/src/UI_TextLabel.o src/UI_TextLabel.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/UI_TextLabel_nomain.o src/UI_TextLabel.cpp;\
	else  \
...
${OBJECTDIR}/src/View_nomain.o: ${OBJECTDIR}/src/View.o src/View.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/View_nomain.o src/View.cpp;\
	else  \
...
${OBJECTDIR}/src/chat_nomain.o: ${OBJECTDIR}/src/chat.o src/chat.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/chat_nomain.o src/chat.cpp;\
	else  \
...
${OBJECTDIR}/src/command_nomain.o: ${OBJECTDIR}/src/command.o src/command.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/command_nomain.o src/command.cpp;\
	else  \
...
${OBJECTDIR}/src/net_nomain.o: ${OBJECTDIR}/src/net.o src/net.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/net_nomain.o src/net.cpp;\
	else  \
